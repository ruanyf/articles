...
1、[中芯国际是怎么成立？](https://www.eet-china.com/mp/a232813.html)（中文）
...
1、[个人网站集成 GitHub issue](https://richard-docs.netlify.app/blogs/b-027) 评论功能（中文）

![](https://cdn.beekka.com/blogimg/asset/202307/bg2023070405.webp)

作者采用 VitePress 搭建博客，采用 gitalk 引入 GitHub issue 作为评论功能。（[@Richard-Zhang1019](https://github.com/ruanyf/weekly/issues/3237) 投稿）
...
1、[ICP Query](https://github.com/yuedanlabs/icp-query-extension)
...
根据文字描述，将二维码转成一幅可扫描的图像。（[@Cobb9527](https://github.com/ruanyf/weekly/issues/3226) 投稿）
