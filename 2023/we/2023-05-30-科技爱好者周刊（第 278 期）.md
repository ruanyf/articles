...
它的底层是安卓系统，通过手机 SIM 卡联网。它带有语音和摄像头，你可以随时跟它交谈。
...
它的售价为699美元（约人民币5100元），每个月还有24美元（约人民币175元）的服务费，这么贵的价格，销售前景真的不乐观。

1、[探路者1号飞艇](https://techcrunch.com/2023/11/08/the-worlds-largest-aircraft-breaks-cover-in-silicon-valley/)
...
飞艇的优势是，可以低空慢速飞行，还可以悬浮在空中，并且非常安静。但是，它的载客量这么小，也不能防大风，很难有什么实际用途。

1、[眼球移植](https://www.scientificamerican.com/article/doctors-complete-first-successful-face-and-whole-eye-transplant/)
...
1、[Steam Deck 的照明](https://idlethumbs.social/@ja2ke/111396017651485944)
...
上图就是广告截图，一个 Steam Deck OLED 在中央，照明完全是由周围的 Steam Deck OLED 带来的。

为了实现这个效果，他们制造了一个巨大的金属圆球，把掌机挂在上面。
...
1、[PageSpyWeb](https://github.com/HuolalaTech/page-spy-web)
...
1、[GWS](https://github.com/lxzan/gws)
...
1、[网页 AI 评审](https://uxaudit.vercel.app/)
...
该网站收录各种 GPT 工具，目前已经收录了6319个。类似的网站还有[AwesomeGPTs](https://awesomegpts.pro/)。（[@airyland](https://github.com/ruanyf/weekly/issues/3617) 投稿）

1、[Bubble](https://github.com/LHRUN/bubble)
...
1、[MacOS 弹窗](https://sixcolors.com/post/2023/11/a-picture-is-worth-a-thousand-permissions-requests/)
