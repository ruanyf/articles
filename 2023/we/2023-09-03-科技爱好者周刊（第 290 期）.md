...
上图是2023年度野生动物摄影师比赛的第一名作品，一只小北极熊在挪威斯瓦尔巴群岛附近漂浮的冰块上，用爪子挖出了一张床，睡着了。（[via](https://www.livescience.com/animals/polar-bears/polar-bear-sleeping-on-tiny-iceberg-drifting-in-arctic-sea-captured-in-heartbreaking-photo)）
...
这9间房子都装了无线的监控摄像头，小偷设法让这些摄像头失效，然后再作案。

![](https://cdn.beekka.com/blogimg/asset/202402/bg2024021501.webp)

小偷所用的设备其实很简单，就是一个 WiFi 干扰器。

![](https://cdn.beekka.com/blogimg/asset/202402/bg2024021502.webp)

无线摄像头拍到的影像，都要通过 WiFi 保存到控制中心的硬盘里面。如果存在大量的干扰信号，阻塞无线摄像头的信道，就会使得影像无法传到硬盘上，即使拍到了，也无法保存。

无线摄像头的这个问题，早就为人所知。目前的解决方法是，关键的监控摄像头最好使用有线连接。
...
1、[卫星碎片削弱地球磁场](https://spaceweatherarchive.com/2024/02/01/will-satellite-megaconstellations-weaken-earths-magnetic-field/)

SpaceX 公司的 Starlink 项目，在地球低轨道上计划部署12000颗卫星，为全球任一地点提供宽带上网，目前已经发射了5000多颗。
...
因为今后几十年，这些卫星都会逐渐解体和坠落。那时，它们会产生大量的金属碎片和颗粒，漂浮在太空中。如果数量足够多，就会在地球外空形成一层巨大的带电粒子层。
...
本文介绍 Web 平台常见的拦截方法，以及如何将拦截代码注入到运行环境中。（[@hughfenghen](https://github.com/ruanyf/weekly/issues/4014) 投稿）
...
一个速度极快的代码编辑器，跨平台，来自 Atom 团队的最新作品。

1、[TCPView](https://learn.microsoft.com/en-us/sysinternals/downloads/tcpview)
...
1、[FontMagic](https://github.com/leibnizli/fontmagic)
...
1、[uv](https://astral.sh/blog/uv)

Rust 语言写的 Python 包管理器，速度非常快，可以替代 pip 和pip-tools。（[@qiaouchicago](https://github.com/ruanyf/weekly/issues/4030) 投稿）

1、[Keep Screen On](https://www.keepscreenon.com/)

![](https://cdn.beekka.com/blogimg/asset/202402/bg2024021906.webp)

打开这个网页，让电脑屏幕保持常亮，对 PC、Mac、Android、iOS 均有效。（[@tufucheung](https://github.com/ruanyf/weekly/issues/4033) 投稿）

1、[background-erase.xyz](https://background-erase.xyz/)
...
OpenAI 推出了视频生成模型 Sora，只要输入文字，就能生成一段60秒的视频，效果惊人。

该模型还没有正式发布，只是公开了生成的视频示例。以下网站收集这些示例，以及对应的提示词。
...
1、[木卫一](https://science.nasa.gov/get-involved/citizen-science/for-your-processing-pleasure-the-sharpest-pictures-of-jupiters-volcanic-moon-io-in-a-generation/)
...
根据维基百科，木卫一是最靠近木星的卫星，直径为3642公里（作为比较，月球直径是3476公里）。由于受到木星巨大引力的影响，木卫一地质活动剧烈，存在400座活火山，是太阳系火山最多的天体。

1、[冰岛火山爆发](https://kottke.org/24/02/incredible-satellite-images-of-the-latest-volcanic-eruption-in-iceland)

冰岛火山爆发的卫星照片，令人惊叹：银白的大地上燃起一朵火焰。

![](https://cdn.beekka.com/blogimg/asset/202402/bg2024021007.webp)

1、[滇越铁路和公斤](https://twitter.com/ruanyf/status/1757002038981112152)

云南的有些地区使用公斤，另一些地区使用市斤，这是为什么？

最近，我听到一个解释，听上去很合理：上个世纪初，法国修建滇越铁路，连接越南和云南。

![](https://cdn.beekka.com/blogimg/asset/202402/bg2024021201.webp)

法国是国际度量衡的发明国，滇越铁路沿线全部改用公斤：河口、屏边、蒙自、开远、昆明。
...
纽约市最古老的脚手架搭建于2002年，当时是为了翻新一栋百年大楼，可是由于各种原因（资金短缺、找不到供应商等等），一直没有完工。直到2023年底，这个已经施工了21年的脚手架终于拆除了。
...
这是不是说，认知能力低的人更可能幸福、健康和长寿？

当然，过度乐观可能会导致糟糕的决策，比如过度消费和负债，使得财务状况很糟糕。
