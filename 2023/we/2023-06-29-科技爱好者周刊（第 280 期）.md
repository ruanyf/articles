...
1、[Rsbuild](https://github.com/web-infra-dev/rsbuild)
...
自相关（autocorrelation）指的是，一个变量与自身存在相关关系。

很多论文都犯了“自相关”的错误，它们提出两个变量之间存在相关关系，但其实是自相关。

举例来说，x 和 y 是两个不相关的变量。它们的散点图如下。
