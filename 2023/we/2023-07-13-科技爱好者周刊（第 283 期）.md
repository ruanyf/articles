...
1、[Google Gemini 的第一印象](https://blog.roboflow.com/first-impressions-with-google-gemini/)（英文）

Gemini 是谷歌刚刚对外公开的一个 AI 模型，具有图片识别能力。

![](https://cdn.beekka.com/blogimg/asset/202312/bg2023121402.webp)

为了评估这个模型，作者对其进行了四项测试（图片问答、文字识别、文档识别、物体检测）。每一个测试都有详细说明，我们可以学习这种评估方法。
...
1、[Photo to Anime](https://photo-to-anime.com/)

![](https://cdn.beekka.com/blogimg/asset/202312/bg2023121601.webp)

这个网站可以将上传的图片动漫化，也可以通过提示文本生成动漫图片。（[@dongan-beta](https://github.com/ruanyf/weekly/issues/3746) 投稿）

1、[GeminiProChat](https://github.com/babaohuang/GeminiProChat)

![](https://cdn.beekka.com/blogimg/asset/202312/bg2023121717.webp)

谷歌最近开放了 Gemini Pro API，这是基于这个 API 的一款开源的极简 UI，可以一键部署，也可以本地运行。查看 [Demo](https://www.geminiprochat.com/)，可以跟它聊天。（[@babaohuang](https://github.com/ruanyf/weekly/issues/3749) 投稿）

另有一个 [Gemini Pro 免费使用站点](https://googlegemini.co/)。（[@lchh5](https://github.com/ruanyf/weekly/issues/3765) 投稿）

1、[CBox](https://github.com/jokimina/cbox-chrome-extension)
...
1、[DartBook](https://github.com/lindeer/dartbook)
...
1、[成语接龙游戏](https://animos.ai/zh-CN#description)
...
网友将周刊迄今的所有内容进行了向量化索引，然后就可以跟周刊聊天了。（[@ahaapple](https://github.com/ruanyf/weekly/issues/3767) 投稿）
