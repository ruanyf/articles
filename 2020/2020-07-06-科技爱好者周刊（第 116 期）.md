...
2、[锂电池对环境的威胁](https://www.greencarcongress.com/2020/07/20200704-un.html)
...
该火箭的最大亮点，就是使用固体燃料，而不是传统的液体燃料。由于固体燃料稳定性高，可以长期保存，所以发射机动性高，不需要发射架，可以在移动车辆上发射，因此，大幅降低发射成本。另一方面，它跟导弹车的发射技术是一样的。

![](https://www.wangbase.com/blogimg/asset/202007/bg2020071411.jpg)

![](https://www.wangbase.com/blogimg/asset/202007/bg2020071410.jpg)

它的每公斤发射费用降到7万人民币左右，每次发射费用约7000万人民币，约等于1000万美金，只是液态燃料火箭的几分之一。中国航天科工集团开发这款火箭，就是作为低成本商业发射的解决方案，但是目前来看，显然还没有完全掌握固体燃料火箭技术。
...
6、[伪随机数生成器](https://github.com/bryc/code/blob/master/jshash/PRNGs.md
)（英文）

伪随机数指的是通过一种算法，由种子值得到的随机数。本文介绍了几种简单的伪随机数算法。

7、[自动生成 JSX 代码的 AI 模型](https://twitter.com/i/status/1282676454690451457)（英文）
