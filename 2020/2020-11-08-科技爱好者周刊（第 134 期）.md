...
这里[有一篇文章](https://blog.cryptohack.org/macos-ocsp-disaster)，解释了到底是怎么回事。希望了解苹果应用生态的朋友，可以读一下。

![](https://www.wangbase.com/blogimg/asset/202011/bg2020111608.jpg)

3、

OCSP 服务器的作用是，验证应用的开发者证书是否有效。这意味着，用户每打开一个应用，苹果公司都会得到通知。这引发了[广泛的担忧](https://sneak.berlin/20201112/your-computer-isnt-yours/)，苹果掌握了太多的用户信息。

更糟的是，OCSP 请求没有加密，是明文的，第三方可以拿到这些数据。

另外，Big sur 允许苹果自家的应用（比如应用商店）[绕过防火墙和 VPN](https://thenextweb.com/plugged/2020/11/16/apple-apps-on-big-sur-bypass-firewalls-vpns-analysis-macos/)，与苹果服务器通信，用户隐私完全暴露了。

4、

苹果公司[最新回应](https://www.macrumors.com/2020/11/15/apple-privacy-macos-app-authenticaion/)，承诺不收集用户，并在下个版本解决证书验证的问题。
...
6、[我放弃 Serverless，改用 Ruby on Rails](https://frantic.im/back-to-rails)（英文）
...
8、[华为、5G 和征服噪音的科学家](https://www.wired.com/story/huawei-5g-polar-codes-data-breakthrough/)（英文）
...
6、[nvidia-patch](https://github.com/keylase/nvidia-patch)

Nvidia 显示卡配合 FFmpeg 进行视频编码时，有并发数量限制（3路并非），这个补丁可以突破这一限制。（[@richardyjzhang](https://github.com/ruanyf/weekly/issues/1498) 投稿）

7、[lazykube](https://github.com/TNK-Studio/lazykube)

![](https://www.wangbase.com/blogimg/asset/202011/bg2020111803.jpg)

终端可视化交互的方式去管理 k8s。（[@elfgzp](https://github.com/ruanyf/weekly/issues/1499) 投稿）
