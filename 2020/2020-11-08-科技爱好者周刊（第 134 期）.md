...
5、[为什么 OCSP 故障会导致 macOS 应用无法打开？](https://blog.cryptohack.org/macos-ocsp-disaster)（英文）

本周，macOS 的新版本 Big Sur 发布，用户升级后发现，未从应用商店下载的应用程序打不开了。原因是苹果的  OCSP 服务超载，无法验证应用程序的开发人员证书。本文解释 OCSP 到底是什么东西。
...
为什么许多人对新冠病毒在全世界造成的大量死亡感到麻木，因为对于我们大多数人来说，这场疫情的最惨痛经历没有很多目击者。
