...
一家英国设计工作室提出了“帐篷教室”的设计，帮助学校搭建室外的帐篷作为教室，一方面利用新鲜空气减少病毒传播，另一方面也可以增大空间保持社交距离。由于英国学校每个班的人数较少，可以达到每个学生间隔两米。
...
这个链接有一个视频，有人花了25分钟，解出了只给出两个数字的数独。
...
Scrum 可以将低于平均水平的开发者转变为普通开发者，但也可以将优秀开发者转变为普通开发者。
