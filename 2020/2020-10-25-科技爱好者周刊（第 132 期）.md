...
5、[如何在 Markdown 文档显示 diff 效果](https://blog.alispit.tel/create-a-git-diff-in-markdown/)（差异）

![](https://www.wangbase.com/blogimg/asset/202011/bg2020110301.jpg)

很多人不知道的一个小技巧，怎么写表示 diff 效果的 Markdown 语法（上图）。

6、[C 代码里面的网址](https://susam.in/blog/urls-in-c/)（英文）
