...
打开终端窗口，需要按下 mod + shift + return，默认情况下就是按下 alt + shift + return。

现在，命令行窗口打开了，占据了所有桌面空间。
...
按下 mod + space，布局模式改成主栏在上方，副栏在下方。主栏在左边，副栏在右边主栏在左边，副栏在右边主栏在左边，副栏在右边主栏在左边，副栏在右边
