...
大家都认同，AI 应用是开发者的机会，而**图形化、低代码/无代码、不需要编程基础的“工作流模式”**，正是 AI 应用开发的入门捷径。
...
大家先看[成品](https://www.coze.cn/s/iDCT55nY/)，可以点进去试用。（建议 PC 访问，UI 还没有适配手机。）
...
至此大功告成，“[AI 文言生成器](https://www.coze.cn/s/iDCT55nY/)”就登录扣子商店，向世界公开了。
...
扣子邀请我，参加**12月19日在上海举行**的“[扣子开发者日](https://mp.weixin.qq.com/s/adDVoDSIxtAMH-havVpvPA)”，也欢迎大家参加。

届时，字节的 AI 工程师会跟大家面对面交流，如何开发和推广 AI 应用。这是很好的学习交流、获取资源的机会，[点击这里](https://mp.weixin.qq.com/s/adDVoDSIxtAMH-havVpvPA)了解详情。
