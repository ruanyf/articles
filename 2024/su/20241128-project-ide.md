...
（3）它可以免费使用（不超过使用额度），发布上线也不收费，适合新手练习。

## 三、示例项目

我们的示例项目，是一个最简单的 AI 应用“AI 文言文生成器”。
...
下面就是开发步骤。为了保证大家跟得上，我会写得比较详细，看起来有点长，但是实际操作是很快的，熟练的话，10分钟就能完成。
...
上面文本中的`{{content}}`，表示此处插入 content 变量的内容。
