...
1、[Python 的命令行小工具](https://www.pythonmorsels.com/cli-tools/)
...
1、[React 组件的 AI 生成器](https://github.com/bravekingzhang/gpt-frontend-code-gen)
...
1、[小幻助理](https://github.com/Richasy/Rodel.Agent)
...
微软为了让用户接受新界面，特别发布了一个应用程序，叫做“微软鲍勃”，教你怎么使用。
...
小狗会让你依次点击各个物件，从而跳出对应的应用程序，让你熟悉使用方法。
...
“微软鲍勃”的评论和销量，都非常糟糕，以至于1996年初这个项目就撤销了，寿命只有不到一年。
...
PCRE 是 Perl 语言的正则库，作者 Philip Hazel 在1998年创建了这个库，那一年他已经54岁了。

今天，他80岁了，还在维护这个库。他正在找接班人，准备移交工作。他说，做梦也想不到，2024年他还在维护它。
