...
1、[家庭机房的搭建感受](https://www.xda-developers.com/five-reasons-my-homelab-is-a-nightmare/)（英文）
...
1、[Jest 与 Vitest](https://www.speakeasy.com/post/vitest-vs-jest)（英文）
...
4、[四象限编辑器](https://github.com/KwokKwok/slide-lab)
...
5、[Git Stats](https://github.com/lixianmin/git.stats)
...
6、[Bootstrap React Logic](https://github.com/dafengzhen/bootstrap-react-logic)
...
他们都会避开每天的高峰时段：炎热的天气，每个人都在忙，消息满天飞。即使你的能力再强，此时都无法逃脱外界的干扰。
