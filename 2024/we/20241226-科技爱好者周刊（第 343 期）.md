...
1、[Gemini 2.5 Pro 会说不](https://everything.intellectronica.net/p/negotiating-with-the-machine)（英文）

本周，谷歌发布 Gemini 2.5 Pro 模型。它的能力很强，迅速登顶。
...
[提示词](https://www.facebook.com/reel/2067904917006222)是：“请把照片里面的角色画成 Q 版，并用12个动作和文字做成表情包。”
...
所以，如果你想重新发明轮子，一定要想清楚两点。第一，你有足够时间吗，尤其是涉及其他人的情况下。

第二，重新发明的范围（或者说，你不打算重新发明什么），以免不必要地偏离主题。
