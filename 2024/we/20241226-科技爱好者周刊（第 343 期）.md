...
（1）中国矿业大学研发了一款[太空挖矿机器人](https://news.qq.com/rain/a/20250316A05V5Z00)，共有6足，其中3个是前进的轮子，3个是挖矿的爪子。

![](https://cdn.beekka.com/blogimg/asset/202503/bg2025032605.webp)

（1）英国民众本周纷纷报告，夜空中发现[螺旋状的云](https://news.sky.com/story/glowing-spiral-appears-in-night-sky-as-met-office-reveals-likely-cause-13335297)。

![](https://cdn.beekka.com/blogimg/asset/202503/bg2025032610.webp)

英国气象局调查后宣布，那是猎鹰9号火箭发射时，快速旋转的箭体喷出的尾气，在太空中瞬间冻结，经过太阳光发射，看上去像云一样。

![](https://cdn.beekka.com/blogimg/asset/202503/bg2025032611.webp)

（1）科学家提出，[生命起源](https://ethz.ch/en/news-and-events/eth-news/news/2025/03/were-large-soda-lakes-the-cradle-of-life.html)可能不是大海，而是封闭的大型碳酸钠湖泊。

![](https://cdn.beekka.com/blogimg/asset/202503/bg2025032604.webp)

因为生命起源需要很高的磷浓度，但是自然界（包括大海）的磷含量很低，只有富含磷的碳酸钠湖泊符合条件。

（1）盈通公司推出一款[有香味的 GPU](https://www.tomshardware.com/pc-components/gpus/this-scent-dispensing-rx-9070-assures-at-least-one-gpu-launch-this-year-doesnt-stink)，内置了香味剂。GPU 运行时，内置的散热风扇就会将香味传出来。
...
1、[我对 MCP 的批评](https://taoofmac.com/space/notes/2025/03/22/1900)（英文）
...
1、[只使用 ESM 模块](https://antfu.me/posts/move-on-to-esm-only)（英文）

![](https://cdn.beekka.com/blogimg/asset/202503/bg2025032612.webp)

本文提出 JavaScript 程序员现在可以放弃 CommonJS 模块了，只使用 ESM 模块，一个原因是`require`命令已经支持加载 ESM 模块了。
...
1、[GoRead](https://github.com/Ray-D-Song/goread)
...
1、[wxlogin](https://github.com/liyaodev/wxlogin)

![](https://cdn.beekka.com/blogimg/asset/202503/bg2025032615.webp)

一个基于 Next.js 的开源应用，让用户通过微信公众号获取验证码，从而在网页端登录。（[@liyaodev](https://github.com/ruanyf/weekly/issues/6372) 投稿）

1、[Bondma](https://github.com/HeroIsUseless/bondma)
...
开源的 AI 应用，根据文字描述和上传的图片生成网页，使用 Claude AI 模型，部署在 Cloudflare worker。（[@mggger](https://github.com/ruanyf/weekly/issues/6371) 投稿）
...
这个网站测试从你的计算机到世界主要的公共 DNS 服务器的速度。
