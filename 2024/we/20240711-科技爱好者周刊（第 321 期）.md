...
紫金山-阿特拉斯彗星（国际编号C/2023 A3）10月9日进入近地点，肉眼可以清晰看到。这几天，世界各地的天文爱好者拍下了许多照片。

![](https://cdn.beekka.com/blogimg/asset/202410/bg2024101607.webp)

该彗星在2023年被紫金山天文台发现，所以由中国天文台命名。

发现之初，曾预测该彗星的最大亮度可达0等，相比之下，北斗星的亮度是2等。目前实际只有4等，但即使如此，它也是近期难得的亮彗星。

该彗星的轨道周期是6万多年，上次光临地球的时候，人类还是石器时代。
...
1、[金字塔的建材](https://www.nbcnews.com/science/environment/egypt-pyramids-giza-nile-branch-study-rcna152494)

埃及金字塔位于沙漠之中，科学家一直很困惑，建造金字塔的巨大石块如何运输？

那些石块每个有2.5吨重，几千年前的古埃及人使用什么方法，将它们运到沙漠之中呢。

![](https://cdn.beekka.com/blogimg/asset/202410/bg2024101403.webp)

最近的一项发现，可能揭示了答案。科学家使用卫星照片，发现尼罗河有一条已经干涸的支流。

几乎所有的金字塔都分布在这条支流的旁边，这说明古埃及人很可能通过水运，将石块运送到建筑地点。
...
（1）一所葡萄牙高校，创下了[现场人数最多的编程课程](https://mathspp.com/blog/teaching-the-worlds-largest-programming-lesson)的世界记录，共有1668名学生到场参加。 

![](https://cdn.beekka.com/blogimg/asset/202410/bg2024101513.webp)

上课内容是《零基础 Python 入门》，从零开始解一个数独游戏。下图是老师在课后领取吉尼斯世界纪录证书。

![](https://cdn.beekka.com/blogimg/asset/202410/bg2024101514.webp)

（1）有人在电源插排植入[窃听器](https://j.021east.com/p/1728896700041676)，然后在网上贩卖，现已被抓。
...
这是 Threads 工程师的一个演讲记录，介绍这个项目的开发内幕。

最有意思的一段话是，这个项目基于 Instagram 的代码库，内部人评价，两者只是布局不同：Instagram 是图片在上，文字在下，Threads 正好反过来。
...
1、[NotesHub](https://about.noteshub.app/)

![](https://cdn.beekka.com/blogimg/asset/202410/bg2024101611.webp)

一个 Markdown 笔记程序，语法功能比较多，有 Web/桌面/手机客户端，支持 Git 仓库同步。

1、[Faker Server](https://github.com/Ray-D-Song/faker-server)

![](https://cdn.beekka.com/blogimg/asset/202410/bg2024101410.webp)

一个基于 Faker.js 的 mock 服务器，用来模拟 API，自带一个前端管理页面，用来定制接口。（[@Ray-D-Song](https://github.com/ruanyf/weekly/issues/5321) 投稿）

1、[Logcat in devtools](https://github.com/nieheyong/logcat-in-devtools)
...
1、[Astro AntfuStyle Theme](https://github.com/lin-stephanie/astro-antfustyle-theme)
...
1、[vitepress-demo-plugin](https://github.com/zh-lx/vitepress-demo-plugin)

![](https://cdn.beekka.com/blogimg/asset/202410/bg2024101518.webp)

Vitepress 插件，支持在页面中插入 Vue/React/HTML 组件。（[@zh-lx](https://github.com/ruanyf/weekly/issues/5331) 投稿）

1、[BroadcastChannel](https://github.com/ccbikai/BroadcastChannel)
...
1、[notion2md](https://github.com/thinkerchan/notion2md)
...
只要输入需求，就会生成对应的全栈应用，可以在页面上运行、编辑和部署该应用。

1、[文字转语音](https://d1tools.com/tools/ai-tts/)
...
1、[电子元件分类器](https://github.com/Vanguard-s/Electronic-Component-Sorter)（Electronic Component Classifier）

![](https://cdn.beekka.com/blogimg/asset/202410/bg2024101103.webp)

一个本机的 AI 工具，根据摄像头的影像，识别电子元件。

1、[Chat100.ai](https://chat100.ai/zh-CN)

![](https://cdn.beekka.com/blogimg/asset/202410/bg2024101411.webp)

免费体验 GPT-4o 和 Claude 3.5 Sonnet 的 AI 在线聊天。（[@aaamomo64](https://github.com/ruanyf/weekly/issues/5322) 投稿）
...
1、[Signature](https://signaturegenerator-ai.com/)
...
1、[今天的上网感受](https://how-i-experience-web-today.com/)
...
这可能是为了激励胖人去走楼梯，运动减肥。但是，有人认为这是公然的歧视。
