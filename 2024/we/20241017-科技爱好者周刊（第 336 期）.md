...
这一段日子，新闻焦点都是 DeepSeek，其他事件或多或少被忽视了。

1月23日，OpenAI 发布了一个 AI 工具，叫做 Operator（操作员）。

![](https://cdn.beekka.com/blogimg/asset/202501/bg2025013006.webp)

我认为，这是一个标志性事件，可能标志着传统互联网的最终消亡。

它与其他 AI 工具截然不同。其他工具都是生成内容，而它能够操作网页，是一个可以操作网页的 AI 代理（国内一般译成智能体）。

产品的介绍文章里，OpenAI 展示了一个例子。你只要说，去旅游网站 Tripadvisor 预定一个评分最高的“罗马一日游”，Operator 就能帮你预定，你根本不必离开当前窗口。

大家想一想，这意味着什么？

以前的 AI，只是让你不必去搜索引擎或问答网站，就能找到答案。如果涉及到网页操作，你还是必须去对应的网站，比如买火车票还是要访问12306。

现在，Operator 为你完成了所有工作，不再需要所有中间步骤了。打开谷歌搜索 Tripadvisor 网址，打开 Tripadvisor 网址，搜索罗马一日游的旅行社，找出评价最高的产品，进行预订，Operator 把这些步骤都替代了。

可以想象，如果 AI 以后日益强大，那么所有的网站都可能被 AI 取代。你可以坐在 AI 面前，让它帮你买东西、叫外卖、存钱，而不再需要去电商网站、外卖网站、银行网站了。

我看到，[一个老外](https://brids.bearblog.dev/openai-just-put-the-final-nail-in-the-coffin-of-the-open-world-wide-web/)预测，以后的商业模式可能是，中间网站都不直接面对用户了，也不搭建网页展示自己了，而是直接把服务卖给 AI 公司，或者提供 API 让 AI 付费访问。

这意味着，传统的、以网站形式向用户开放的互联网走向消亡。

网络服务不再需要直接面向用户了，只要面向 AI 就可以了，消费者最终只使用 AI。未来的互联网，各种网站可能演变成一个结构化数据层，专门供 AI 使用。
...
1、[DeepSeek R1 模型分析加拿大关税](https://stephaniekelton.substack.com/p/the-impact-of-25-tariffs-on-canadian)（英文）

![](https://cdn.beekka.com/blogimg/asset/202501/bg2025012911.webp)

DeepSeek R1 是一个推理模型，在回答问题时，会同时显示推理过程。

作者问它，美国对加拿大征收25%的关税，对加拿大 GDP 有何影响。DeepSeek 只用了12秒就给出了预测结果，与一家加拿大分析机构的预测基本接近。

而且，它的推理过程是一篇高质量的经济学论文，令人叹为观止。

1、[Canva 如何建立图像搜索](https://www.canva.dev/blog/engineering/image-replacement-in-canva-designs-using-reverse-image-search/)（英文）

![](https://cdn.beekka.com/blogimg/asset/202501/bg2025012910.webp)

本文介绍 Canva 公司如何使用向量嵌入，建立相似图片搜索功能。

下面是一篇类似的文章，也是使用向量嵌入，[《基于 pgvector 和 Next.js 构建语义电影搜索》](https://blog.6nok.org/building-a-semantic-movie-search-demo-with-pgvector-and-next.js/)。
...
-- [Hacker News 网友](https://news.ycombinator.com/item?id=42862390)。最受 DeepSeek 冲击的不是英伟达（你还是需要显卡），而是 OpenAI 和 Anthropic 这种高价模型公司。
...
现在的苹果公司，在延长单一产品的寿命方面做得很好，但我觉得，他们可能没有很疯狂，没有去做一些疯狂的事情。我认为，乔布斯离去的一大损失，就是苹果公司不再做很多奇怪的事情了。
