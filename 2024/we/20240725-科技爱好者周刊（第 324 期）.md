...
上个月，有一个不太引人注目的科学发现：[人类已知的最大质数](https://www.163.com/dy/article/JF9HFDUG0514B52J.html)出现了。
...
报道讲述了背后的精彩故事，**发现这个数字的人不是数学家，而是程序员**。我读得津津有味，下面分享给大家。
...
那天晚上，他收集衣物，准备从加州返回阿拉巴马州的老家。出门之前，他决定远程登录服务器，看一下正在运行的脚本。

他原以为，就像过去一年的每次远程登录一样，脚本都会没有结果，或者报错。但是，那天不一样，脚本给出了运行结果。

杜兰特意识到，他发现了世界上新的最大质数。他立刻告诉同伴这个消息，然后开始仔细检查脚本的结果。
...
杜兰特为了找到这个数字，动用了17个国家/地区24个数据中心和两家云服务商的服务器，进行协同计算。
...
这个新的最大质数已经到了4100万位，GIMPS 计划依然在悬赏第一个找到十亿位质数的人。
...
美国心理学会的一项研究表明，消耗脑力的思考，会导致烦躁、沮丧或其他负面情绪，所以“思考有害健康”这个观点是对的。
