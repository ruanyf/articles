...
1、[编程十年的感悟](https://ramsayleung.github.io/zh/post/2024/编程十年的感悟/)（中文）
...
1、[我给博客添加 dark mode](https://taxodium.ink/setup-blog-color-scheme.html)（中文）
...
微软官方推出的工具，将各种格式的文件（主要是 Office 文件）转成 Markdown 格式，[线上体验](https://markitdown.pro)。
...
1、[GitHub Cards](https://github.cards)
...
1、[Beautify Screenshots](https://postspark.app)

![](https://cdn.beekka.com/blogimg/asset/202412/bg2024122306.webp)

截图美化工具。（[@cxhello](https://github.com/ruanyf/weekly/issues/5752) 投稿）

1、[单词收藏助手](https://chromewebstore.google.com/detail/单词收藏助手-划词翻译-收藏单词/hlchmmedadpbeefeikleobfgjdieclho)
...
1、[github-assistant](https://github-assistant.com)

![](https://cdn.beekka.com/blogimg/asset/202412/bg2024122301.webp)

该网站可以对 GitHub 代码库提问，由 AI 来回答，比如“过去30天谁的提交次数最多”。

1、[Liubai](https://github.com/yenche123/liubai)
...
1、[Smart Alt Text Generator Generator](https://ai-alttext.com/)
...
1、[AI 调色盘生成器](https://colorify.rocks)
