...
1、德国大众汽车宣布，未来的所有车型都会配备[物理按钮](https://www.autocar.co.uk/car-news/new-cars/volkswagen-reintroducing-physical-controls-vital-functions)，用于最重要的功能。

![](https://cdn.beekka.com/blogimg/asset/202503/bg2025030904.webp)

上图是大众 ID.3 车型的控制台，下方都是按钮。

该公司表示，汽车不是手机，不能都靠触摸屏，必须有真实的触感。
...
著名程序员 Simon Willison 在3月7日演讲的文字稿，通俗地介绍 AI 在过去一年的巨大飞跃，值得一读。

1、[如何用 Claude Code 反编译代码](https://ghuntley.com/tradecraft/)（英文）

![](https://cdn.beekka.com/blogimg/asset/202503/bg2025030616.webp)

作者演示了一个惊人的例子，使用 Anthropic 发布的 Claude Code，将 Webpack 的编译出来的文件反编译，还原成源代码的结构。

1、[CSS 跨文档视图转换](https://simonwillison.net/2025/Mar/10/building-websites-with-llms/)（英文）
...
苹果有机会利用 AI 发挥其硬件优势，鼓励开发者在本地运行 AI 模型。
