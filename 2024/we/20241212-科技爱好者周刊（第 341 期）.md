...
这是世界第六例全人工心脏植入，前五例的人工心脏都只是过渡，病人后来又移植了其他人的心脏。

如果机器心脏以后技术成熟了，人类的寿命可望大幅延长。

1、[手机改路由器](https://www.cnx-software.com/2025/03/02/citronics-built-a-router-based-on-the-fairphone-2-mainboard/)
...
1、[静音图标](https://www.macrumors.com/2025/03/07/new-macbook-air-corrects-design-mistake/)
...
1、[汽车的物理按钮](https://www.autocar.co.uk/car-news/new-cars/volkswagen-reintroducing-physical-controls-vital-functions)
...
著名程序员 Simon Willison 在3月7日演讲的文字稿，通俗地介绍 AI 在过去一年的巨大飞跃，很好的综述。
...
Cursor 是现在非常流行的一个 AI 代码编辑器，它的用户论坛上爆出一个帖子，有人发现它会上传 .env 文件，里面都是环境参数。

1、[JSON 与 JavaScript 的对象成员顺序](https://blog.gslin.org/archives/2025/03/07/12299/json-%E8%88%87-javascript-%E5%86%8D-object-%E8%A3%A1%E9%9D%A2%E5%85%83%E7%B4%A0%E9%A0%86%E5%BA%8F%E7%9A%84%E5%B7%AE%E7%95%B0/)（中文）

![](https://cdn.beekka.com/blogimg/asset/202503/bg2025030702.webp)

JSON 与 JavaScript 的对象，里面的成员顺序有没有规定？本文探讨这个问题。

1、[Go 语言错误处理机制的优点](https://rauljordan.com/why-go-error-handling-is-awesome/)（英文）
...
1、[Java Thread Dump](https://www.threadanalyzer.online/)
...
1、[Telegram Files](https://github.com/jarvis2f/telegram-files)
...
1、[Obsidian 云盘同步插件](https://github.com/ai-bytedance/obsidian-cloud-sync)
...
上周，Mistral AI 发布了号称史上最强的 OCR 识别工具，有良好的公式和表格的识别能力。
...
1、[Code-Review-LLM-Gitlab](https://github.com/mimo-x/Code-Review-GPT-Gitlab)
...
1、[人话翻译器](https://github.com/DemoJ/HumanizeText)
...
1、[Mistral OCR](https://github.com/simonw/tools/blob/main/python/mistral_ocr.py)

著名程序员 Simon Willison 的一个 Python 脚本，使用 Mistral AI 进行文字识别（OCR），参考作者的[介绍文章](https://simonwillison.net/2025/Mar/7/mistral-ocr/)。
...
1、[JetBrains Maple Mono](https://github.com/SpaceTimee/Fusion-JetBrainsMapleMono)
...
1、[BeddyStories](https://beddystories.com/zh)
