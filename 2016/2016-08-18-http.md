...
本文介绍HTTP协议的历史演变和设计思路，主要参考了 [Journey to HTTP/2](http://kamranahmed.info/blog/2016/08/13/http-in-depth/) 和[维基百科](https://en.wikipedia.org/wiki/Hypertext_Transfer_Protocol)。
