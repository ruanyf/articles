...
这个摩天轮的直径为180米，一共有36个乘客仓，每个可以容纳25位游客。

![](https://cdn.beekka.com/blogimg/asset/202304/bg2023041107.webp)

1、[AI 合照](https://medium.com/@socialcreature/ai-and-the-american-smile-76d23a0fbfaf)
...
这些照片都是虚构的，但是显示了 AI 的一个很实用的用途，就是修改合照效果。我们完全可以将真实的合照提供给 AI，使得照片上的每个人都表情生动地笑起来。
...
1、 [HTML 电子邮件不再需要`<table>`](https://fullystacked.net/posts/modern-html-email/)（英文）

![](https://cdn.beekka.com/blogimg/asset/202304/bg2023040904.webp)

编写电子邮件代码，以前要用`<table>`标签来做排版。随着 Windows 上的 Outlook 采用 Edge 引擎，实际已经不需要这样做了。

1、[prompt 写作指南](https://boostpixels.com/guide)（英文）

![](https://cdn.beekka.com/blogimg/asset/202304/bg2023040903.webp)

AI 图像生成引擎的 prompt（提示）怎么写？本文是一篇教程，用示例一步步教你。

虽然针对的是 BoostPixels 引擎，但是很有参考价值。本文是详细版，还有一篇[简明版](https://boostpixels.com/short-guide)，可以先看后者。
...
1、[OPS/OpenPromptStudio](https://moonvy.com/apps/ops/)

![](https://cdn.beekka.com/blogimg/asset/202304/bg2023041202.webp)

AI 提示词的图形化 Web 管理界面，自动将中文输入译成英文文，并对提示词进行分类标签管理。（[@xcuyao](https://github.com/ruanyf/weekly/issues/3044) 投稿）

1、[Anonymous Chat Room](https://github.com/velor2012/anonymous-chat-room)
...
1、[SQLkiller](https://www.sqlkiller.com/)

![](https://cdn.beekka.com/blogimg/asset/202304/bg2023041205.webp)

使用 AI 自动生成 SQL 语句的工具，支持多种数据库。用户需要用户提供“表结构”，并用自然语言描述想要什么数据。（[@Benxzz](https://github.com/ruanyf/weekly/issues/3047) 投稿）
...
开源的 SSL 证书监控平台，证书到期自动邮件提醒，支持 Docker 部署。（[@mouday](https://github.com/ruanyf/weekly/issues/3038) 投稿）

1、[x-crawl](https://github.com/coder-hxl/x-crawl)
...
1、[如果生在贫民窟](https://sea.mashable.com/life/23098/7-of-the-worlds-richest-get-reimagined-as-poor-people-by-midjourney)

大多数的人不能逃脱他的出生环境。那些顶级富豪如果生在贫民窟，还会有现在的人生吗？
