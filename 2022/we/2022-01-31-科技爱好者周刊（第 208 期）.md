...
1、[世界最高输电塔](https://j.eastday.com/p/1652785311033170)
...
这对输电塔之所以要造得这么高，原因是它们之间的高压电线就在长江上方，下方必须留出足够高度，供大型船只通航。
...
4年前，一个程序员发帖称，他训练了一个模型，可以从 X 光片识别早期乳腺癌。最近，他又发帖了，转向研究脑癌治疗，记者就采访了他。

1、[寻找“树王”辛达布](https://mp.weixin.qq.com/s/UHAnsrvzu-Hc9orfICwv3Q)（中文）

![](https://cdn.beekka.com/blogimg/asset/202205/bg2022052109.webp)

本文讲述研究人员如何在墨脱县寻找和测量中国大陆最高的树。

1、[GitHub Markdown 支持数学公式渲染](https://github.blog/changelog/2022-05-19-render-mathematical-expressions-in-markdown/)（英文）

![](https://cdn.beekka.com/blogimg/asset/202205/bg2022052105.webp)

GitHub 宣布，支持 Markdown 里面的 LaTeX 数学公式渲染，渲染引擎是 MathJax。

1、[网络迷踪初探](https://sspai.com/post/73193)（中文）
...
1、[失败的谷歌 I/O 2022大会](https://arstechnica.com/gadgets/2022/05/googles-past-failures-were-on-full-display-at-i-o-2022/)（英文）

![](https://cdn.beekka.com/blogimg/asset/202205/bg2022052402.webp)

本文认为刚刚举办的谷歌 I/O 2022大会完全失败，根本没有拿出让大家兴奋的新产品，而是把那些已经失败好几年的产品重新捡起来：安卓平板、谷歌钱包、谷歌眼镜、安卓手表…… 谷歌这家公司似乎迷惘了，作者认为它迫切需要告诉大家，它的战略方向是什么。
...
1、[Regolith](https://regolith-linux.org/)

![](https://cdn.beekka.com/blogimg/asset/220204/bg2022040406.webp)

一个 Linux 的发行版，目标是提供整洁高效的现代桌面环境，底层是 Ubuntu、GNOME 和 i3。

1、[pNPM](https://pnpm.io/zh/)

![](https://cdn.beekka.com/blogimg/asset/220204/bg2022040604.webp)

一个老牌的 node.js 包管理器，支持 npm 的所有功能。它的模块是全局储存，每个项目内部使用硬链接，所以省空间，而且安装速度快。

1、[CRX viewer](https://github.com/Rob--W/crxviewer)

![](https://cdn.beekka.com/blogimg/asset/220204/bg2022040614.webp)

一个浏览器插件，只要访问 Chrome 网上商店的某个插件主页，就可以查看该插件的源码。它还有[在线版](https://robwu.nl/crxviewer/)。
...
1、[Webcamtaxi](https://www.webcamtaxi.com/en/)

![](https://cdn.beekka.com/blogimg/asset/202203/bg2022033115.webp)

Youtube 有摄像头直播频道，可以看到世界各地的实时风景。该网站就是收集这些频道，按照地区和内容分类。
...
你能说清它们的区别吗？把相关的功能分成四个品牌，简直是挑战普通用户……
