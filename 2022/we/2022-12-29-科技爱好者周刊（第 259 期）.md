...
1、[当人类数据用完，AI 或将越来越笨](https://m.thepaper.cn/newsDetail_forward_23467960)（中文）

![](https://cdn.beekka.com/blogimg/asset/202306/bg2023061509.webp)

AI 模型能用自己生成的数据训练吗？英国科研人员发表论文，发现这种情况下，模型将会崩溃。

2、[高效计算三角函数的 CORDIC 算法](http://www.longluo.me/blog/2023/06/07/CORDIC-algorithm/)（中文）
...
7、[视觉信息论](https://colah.github.io/posts/2015-09-Visual-Information/)（英文）

![](https://cdn.beekka.com/blogimg/asset/202305/bg2023052501.webp)

这篇长文用大量例子，讲解怎么用可视化表示信息。

8、[空气过滤机与正压新风系统的比较](https://www.airgradient.com/open-airgradient/blog/air-purifier-vs-positive-pressure-fresh-air-system-an-unfair-battle/)（英文）
