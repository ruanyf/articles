...
1、[我用 ChatGPT 发现代码 Bug](https://www.wdbyte.com/java/chatgpt-files-list.html)（中文）
...
划词翻译工具。选中一个词以后，它会唤起一个本机的 WebView 窗口，在该窗口中返回翻译结果。（[@fzdwx](https://github.com/ruanyf/weekly/issues/2903) 投稿）

1、[夜视仪](https://github.com/luoxuhai/NightVision)
...
1、[bing_wallpaper](https://github.com/xiqishow/bing_wallpaper)
...
1、[静态 Mastodon 服务器](https://github.com/rothgar/static-mastodon)

![](https://cdn.beekka.com/blogimg/asset/202302/bg2023022009.webp)

Mastodon 是一个分布式社交网络，作者演示了只用静态文件，就可以别人收到你的消息，参见[介绍文章](https://justingarrison.com/blog/2022-12-06-mastodon-files-instance/)。（[@DejavuMoe](https://github.com/ruanyf/weekly/issues/2932) 投稿）
...
1、[街景奇观](https://neal.fun/wonders-of-street-view/)（Wonders of Street View）
...
1、[handsome-css3-lib](https://www.handsome-css.com/)
