...
![](https://www.wangbase.com/blogimg/asset/201912/bg2019120402.jpg)

美国科学家宣布，240个十进制位的整数分解成功（相当于795个二进制位），找到了它的两个大质数因子。这是已经公布的最高纪录，此前的记录是768个二进制位整数。

整数分解是加密学的基石，一旦实现快速的整数分解，现代的加密方法都会失效。本次分解在 2.1G CPU 上需要4000核年，即单核运算需要4000年。
...
传统纸张都是使用植物纤维制作，因为可能会破坏环境。目前，一些制造商正在推出石头做的纸张，这种纸张防水、耐用、更加环保，而且不需要树木，生产过程不需要漂白剂，使用的水也较少。
