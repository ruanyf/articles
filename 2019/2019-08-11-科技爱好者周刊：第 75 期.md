...
现在，全世界都在制造电动汽车。美国一家媒体[认为](https://www.detroitnews.com/story/business/autos/2019/09/05/shift-electric-vehicles-radically-change-auto-factories/2208961001/)，这会使得汽车工人大量失业，我觉得说的很有道理。

传统汽车是机械装置，需要大量零件，单单是动力传动系统就多达2,000个零件。但是，电动汽车是一个电子装置，核心是电动机和电池组，零件数量大大减少，变速器、散热器、燃油喷射器、油箱、排气系统，这些都不需要。

**电动汽车不仅零件少，而且电动机和电池组都可以外部采购，根本不需要太多工人。**

未来的汽车公司，很可能就像今天的电脑公司和手机公司：核心部件都是采购的，自己只负责组装和软件系统。甚至可能组装都外包出去，自己只做品牌。
...
数学家一直猜想，任意一个整数都可以分解成三个整数的立方和，n = x^3^ + y^3^ + z^3^。

2019年之前，100以下的自然数，只有`33`和`42`没有分解成功。
