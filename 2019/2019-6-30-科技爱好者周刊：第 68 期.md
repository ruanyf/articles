...
（题图：松江方塔，上海，2018。该塔高九层，始建于唐朝，清朝重修，应袭了唐代砖塔风格。）

一个月之前，我在周刊讨论区发了一个帖子[《谁在招人？》](https://github.com/ruanyf/weekly/issues/692)，欢迎企业免费张贴招聘/实习信息。现在已经有30多家公司的100多个岗位，找工作的朋友可以关注。

有的读者私下问我：“这些公司怎么都没写报酬呢？工资会不会给的偏低？”我心想，你怎么会有这种担心！**普通程序员的工资差别能有多大呢？**

程序员是一个高度流动的行业。一家公司如果待遇偏低，肯定留不住人。普通程序员的工资，最终来说完全取决于 IT 行业的平均利润率和供需状况。在待遇上，公司与公司之间的差别不会特别大。

**程序员分为两种，一种是需要找工作的普通程序员，另一种是不需要找工作的高级程序员，企业争相邀请他加入。**

对于普通程序员来说，重要的不是找一份工资高的工作，而是设法让自己尽快变成高级程序员，可以在这个行业里面为自己定价，而不是让别人给你定价。
...
西门子公司的很多软件都是外包开发的。一个外包程序员在软件里面留下了一个逻辑炸弹，设置在某个日期后触发，会使得软件崩溃。
...
- [无人机炸弹](https://twitter.com/hackermaderas/status/1132774476389801989)的实物被贴到了推特，可以编程指定飞行轨迹，具有12分钟飞行时间，或20分钟滞空时间。难以想象，这种武器普及的后果。
