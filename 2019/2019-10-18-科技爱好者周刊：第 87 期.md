...
这篇文章探讨了，为什么 Python 2 升级到 Python 3 花了这么长时间（超过10年）？主要原因有两个，一是企业升级的成本很高，且有很大风险，二是 Python 3 一开始的时候优势并不大， 没有足够的升级诱因。

文章举例，Dropbox请了语言创始人 Guido 负责升级，结果干了三年，直到 Guido 退休都没完成。其他公司一看，更犹豫了要不要升级。
