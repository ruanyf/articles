...
每年都有很多新人，离开校园，加入 IT 行业。

![](https://www.wangbase.com/blogimg/asset/201912/bg2019121805.jpg)

多年前，我推荐过一篇文章给所有新入行的朋友。题目叫做[《不要自称为程序员》](http://www.ruanyifeng.com/blog/2011/10/dont_call_yourself_a_programmer.html)，其中说得最好的是下面这段话。

> 公司最关心的（或者说唯一在乎的）事情，就是增加收入、降低成本。因此，它们实际上需要的不是程序员，而是能够帮助它们增加收入、降低成本的人。它们雇佣你，是为了让你帮它们完成某个可以增加收入、降低成本的项目，而不是为了让你追求个人的软件成就。

那篇文章可以让你了解行业的真相，理解很多事情。

![](https://www.wangbase.com/blogimg/asset/201912/bg2019121806.jpg)

今天，我想再推荐一篇文章[《新工程师要干的五件事》](https://evanliman.to/2019/10/06/so-youre-a-new-grad-software-engineer.html)，谈的是新人应该怎么做。如果说前一篇文章是“道”，这篇文章就是“术” 

它提到，新人加入一个开发团队时，要干五件事。前面四件都是常识，我想大多数人都知道，比如了解项目架构、了解流程、有针对性地补强自己、改善现状，尝试关掉几个 issue 等等。

但是最后一件事，很多新人可能没意识到，应该要去做，而且完全有能力做，那就是 **你要为团队写文档** 。

![](https://www.wangbase.com/blogimg/asset/201912/bg2019121807.jpg)

国内的现状是，程序员的时间都被项目占据了，往往没有余力写文档。新人加入以后，想了解技术细节，没有文档可看，就是老的团队成员跟你口头说一下，然后让你自己去看代码。你正好趁这个机会，一边看代码，一边尽量补写一些文档。

你不需要写得很好，只要忠实地记录代码的线索、架构的细节，能为以后的人节省一点时间，那就是有价值的。

写文档对一个人的锻炼是很大的。文档写得清晰，就是思路清晰，意味着你对问题能够理解贯通了。写出来的东西，不仅将来自己可以查阅，还可以给其他成员使用。如果别人都看你写的文档，久而久之，你就会成为项目的代言人，别人有问题就会来找你。
...
> - [微软](http://www.sohu.com/a/360216894_499322 )宣布，将在2020年底前发售下一代游戏主机 Xbox Series X。它的造型是一个竖向的长方体，顶部有散热的栅格，性能是 Xbox One X 的四倍。
