...
[加拿大和美国](https://www.bbc.com/news/science-environment-57751918)最近出现有记录以来的最高温，许多城市达到40多度。更糟的是，这些地区平时气温很低，所以大部分居民都没装空调。
...
CSS 命令 `font-variant-east-asian: traditional;`，可以网站字体从简体变成繁体。

1、[Tensorflow 开发者认证记录](https://nekonull.me/posts/tf-cert-blog/)（中文）
...
1、[成都市城市轨道交通线网规划](https://github.com/cmoseses/cmoseses.github.io)（2021版）

![](https://cdn.beekka.com/blogimg/asset/202107/bg2021070811.jpg)

成都市2021年7月6日公布了《城市轨道交通线网规划图》，但是不方便缩放操作。作者写了一个静态页面将其和百度地图结合，方便查看未来地铁是否经过了你的家门了。（[@cmoseses](https://github.com/ruanyf/weekly/issues/1836) 投稿）

1、[五笔输入法7天速成](https://github.com/ruanyf/weekly/issues/1830)
...
1、[Zsh 的最佳主题](https://www.slant.co/topics/7553/~theme-for-oh-my-zsh)
...
一款卡片式笔记软件，界面非常清爽，有跨平台多种客户端，支持多端同步。（[@RangeChoi](https://github.com/ruanyf/weekly/issues/1821) 投稿）
...
1、[ES2021 新语法点](https://h3manth.com/ES2021/)（英文）

ES2021 已经通过了，成为正式标准，本文简要介绍了这些 JavaScript 的新语法。
