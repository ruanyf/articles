...
1、[EFTP](https://github.com/newham/eftp) 
...
1、[Windows 365](https://www.microsoft.com/en-us/windows-365)
...
它的最大好处是，用户在各种系统上（包括 PC 和手机）使用同一个 Windows。你在一处中断的工作，换一个地点，可以接着做。下图是浏览器里面使用桌面版的 PowerPoint。

![](https://cdn.beekka.com/blogimg/asset/202107/bg2021071506.jpg)

用户支付月费，购买这个服务。云 PC 基于 Azure 虚拟桌面，初期提供12种配置，最低的入门级是单个 CPU、2GB RAM 和 64GB 存储。
...
![](https://cdn.beekka.com/blogimg/asset/202107/bg2021071501.jpg)
...
1、[详解像素和像素密度](https://blog.infolink.com.tw/2021/rediscover-pixel-dpi-ppi-and-pixel-density/)（中文）
...
1、[markdown-css-smartisan](https://github.com/nihaojob/markdown-css-smartisan)
...
1、[Kindle2Flomo](https://github.com/Tit1e/kindle2Flomo)

![](https://cdn.beekka.com/blogimg/asset/202107/bg2021071418.jpg)

Kindle 笔记导出工具，可以在线导出，然后可以写入笔记软件 Flomo。（[@chempeng](https://github.com/ruanyf/weekly/issues/1842) 投稿）

1、[popular-message](https://github.com/nihaojob/popular-message)
