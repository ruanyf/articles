...
1、[静态网站如何启用数据库查询](https://phiresky.github.io/blog/2021/hosting-sqlite-databases-on-github-pages/)（英文）

![](https://cdn.beekka.com/blogimg/asset/202106/bg2021063012.jpg)

作者演示了如何将一个 SQLite 数据库文件，作为静态网站的后端，可以从前端直接发出查询请求。

之所以可以实现这种操作，原因有两个：一是SQLite 以页为单位存储数据，每页默认是 4KB，可以按页读取数据；二是前端可以用 sql.js 模拟一个内存文件系统，从而实现按页读取文件。（[@joyc](https://github.com/ruanyf/weekly/issues/1820) 投稿） 
...
1、[gum](https://github.com/gauseen/gum)

![](https://cdn.beekka.com/blogimg/asset/202106/bg2021063011.jpg)

一个命令行的 Git 用户管理器，适合需要使用不同身份，向不同仓库提交代码的情况。（[@gauseen](https://github.com/ruanyf/weekly/issues/1816)  投稿）

1、[BookmarkHub](https://github.com/dudor/BookmarkHub/blob/main/README_cn.md)

![](https://cdn.beekka.com/blogimg/asset/202106/bg2021063010.jpg)

一个浏览器插件，可以跨浏览器进行书签同步，存储使用的是 GitHub Gist。（[@weavers1f](https://github.com/ruanyf/weekly/issues/1815) 投稿）

1、[EssayKiller](https://github.com/EssayKillerBrain/EssayKiller_V2)
...
1、[nuoshell](https://www.nuoshell.com/)

一款 Mac 的桌面 SSH 客户端软件，集多功能于一身，简单、免费。（[@anlityli](https://github.com/ruanyf/weekly/issues/1814) 投稿）
