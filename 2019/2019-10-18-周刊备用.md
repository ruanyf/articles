...
一个将文字/代码转换成图片的网页工具，可以自定义主题、水印、阴影特效等。（[@chenjiayao](https://github.com/ruanyf/weekly/issues/1798) 投稿）

1、[热重载 C](https://cjting.me/hot-reload-c/) （中文）

热重载指的是，在不重启的情况下更新应用。脚本语言都能支持这个功能，本文使用通俗的语言，介绍如何让 C 语言这样的编译语言，也支持热重载。（[@cj1128](https://github.com/ruanyf/weekly/issues/1796) 投稿）

1、[葫芦笔记](https://www.hulunote.com/)
