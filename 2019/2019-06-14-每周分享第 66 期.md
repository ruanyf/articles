...
生存是一种即时策略游戏，所有的人都是这场游戏的玩家。财务自由的人就是赢家。
...
创业是财富游戏，政治是地位游戏。因为上面的原因，我认为，创业值得参与，政治不值得参与。而且，要排除那些零和的创业项目，比如抢票技术、秒杀技术、游戏外挂等等。
...
该艺术家拒绝将雕塑移除，市政府不得不出钱移除，然后起诉了他。普渡医药公司因此发表声明，表示阿片类药物的问题，以后将不再主动推销该药物。
...
该法规规定，电动车必须产生跟传统发动机相似的噪音。特别是在倒车或行驶速度低于每小时19km时，汽车必须发出声音。目前，电动车占整个欧盟新车市场的6.6％，去年该比例是5.6%。
...
美国参议院6月27日通过法律，要求减少电网自动化的程度，不得完全采用计算机控制，必须可以手动控制，目的保护是电网免受黑客攻击，防止受攻击出现大规模停电。

2015年乌克兰的电网遭受攻击，导致25万人停电，当时的人工控制防止了攻击产生更大的停电。美国议员说：“如果乌克兰不依靠人工运行电网，攻击的结果可能会更糟。” 
...
阿联酋在沙漠之中，建设了一个世界最大的太阳能电厂，一共安装了320万块太阳能板，可以为9万人供电。峰值发电量是1180兆瓦，相比之下，美国最大的太阳能设施是569兆瓦。

8、**天宫二号返回地球**

![](https://www.wangbase.com/blogimg/asset/201907/bg2019071902.jpg)

天宫二号空间实验室于7月19日返回地球，少量未燃烧尽的残骸落入南太平洋。这显然是为了避免天宫一号失控的结果，2018年4月天宫一号不接受地面控制而坠落，最后很幸运落在海洋里面。所以，天宫二号选择了受控坠毁。

天宫二号于2016年9月15日在酒泉发射，是中国第一个真正意义的空间站。2016年10月17日，航天员景海鹏和陈冬在里面待了30天。由于它只有10.4米长，直径3.35米，跟一辆大卡车差不多，在这里待30天一定很折磨。
...
- [亚马逊公司](https://www.bbc.com/news/business-48990482)7月15日举办会员日活动，同一时间，它在德国、英国、美国配送中心的工人都计划进行罢工，抗议劳动量过大。一名工人说：“我必须每8秒取一件货物，每小时332件，每天工作10小时。”

- [美国队印度](https://www.maa.org/news/us-places-first-at-international-mathematics-competition-in-uk)今年与中国队并列，夺得国际中学生奥林匹克数学竞赛团体冠军。下面是美国队6个成员的合影，其中5个是华裔。

![](https://www.wangbase.com/blogimg/asset/201907/bg2019072011.jpg)

- [日本网友](http://2chcn.com/178862/)贴出京都动画工作室的内部照片。该工作室被一个神经病放火，已经有30多个动画师遇难。据说，有人为了抢救画稿，而来不及逃离。

![](https://www.wangbase.com/blogimg/asset/201907/bg2019071901.jpg)economictimes.indiatimes.com/tech/hardware/apple-starts-shipping-india-made-iphones-to-european-markets/articleshow/70166859.cms?from=mdr)生产的 iPhone 开始出口欧洲。
...
幂等指的是不管运行多少次，都会得到同样的结果。幂等性的 Bash 脚本的最大好处是，如果前一次执行中断，那么完全可以从头运行。本文讲解如何运用各种命令行参数，做到这一点。

2、[不使用 Cookie 如何追踪用户？](http://lucb1e.com/rp/cookielesscookies/)

![](https://www.wangbase.com/blogimg/asset/201907/bg2019070914.jpg)

追踪用户的常见做法是，把用户 ID 保存在 Cookie。如果不用 Cookie，可以追踪吗？答案是可以的，一种思路是浏览器会缓存静态资源，将用户 ID 保存在静态资源里面就可以。本文使用 etag 保存用户 ID。

3、[中国互联网报告2019](https://www.scmp.com/china-internet-report)（英文）

《南华早报》出品的中国互联网行业的现状和预测报告，大部分内容不是文字，而是数据可视化图表。
...
七月初，cloudflare 曾经全球中断服务，原因是一个正则表达式耗尽了 CPU 资源。现在，他们公布了这个正则表达式（上图），看着是很复杂，简化以后，有问题是这个模式 `.*.*=.*` 。七个字符里面包含三个贪婪匹配，从而导致急剧放大的计算量。上面链接详细解释，为什么这个模式有问题。

5、[脊髓的带宽](https://www.reddit.com/r/askscience/comments/7l56sb/how_much_bandwidth_does_the_spinal_cord_have/)（英文）

脊髓是人体的中枢神经传递信号的通路，它的带宽有多大？一个神经科人士估算，可以达到每秒16.625 GB的数据，比如 5G 通信的最快速度，还要快几十倍。
...
BBC 的长篇图片报道。Safa 和 Marwa 是一对头部连在一起的连体姐妹，一个英国的医疗团队试图将她们分开。希望有人把这片报道译成中文。
...
自然科学基金要求注明，所申请的项目属于原创性研究，还是聚焦前沿。相当多的人分不清这两者，我所在的学科组上会讨论的大约300个项目中大约有20%标注为“原创性研究”，其实全部属于“聚焦前沿”。
...
团队负责比特大陆矿池及多币种区块链浏览器项目研发，欢迎具有3年以上工作经验。欢迎加入团队，探究新一代区块链前端技术架构解决方案的同学加入。点击查看[岗位详细信息](https://github.com/btccom/blackboard)。  
