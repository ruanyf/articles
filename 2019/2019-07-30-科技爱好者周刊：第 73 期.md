...
为了强化这种愿望，App 还推出连续打卡送积分的活动，并且建立跑步圈，看看朋友里面谁领先、谁落后。有了这样的措施，很多人就真的坚持下来了，跑步从健身活动，变成带有心灵修炼和社交活动的色彩。

这就是数据的威力，仅仅把数据记录下来，就很可能改变一个人的行为。GitHub 的个人页有一个日历栏目，只要你当天有代码提交，那一天的小方格就会变成绿色。如果这一年，你每天编码，日历全是绿的，否则就会有白色的小方块。并且，所有人都可以查看这个“编码日历”。
...
-- [HN 读者评论](https://news.ycombinator.com/item?id=20934553) iPhone 11 发布会
...
应聘者主导公司产品研发迭代，有独立开发前后端的能力。必备技术栈关键字: Vue/React， Node， NoSQL， DevOps， 微信开发。希望你对公司所在领域感兴趣，有见解。

详细要求见[这里](https://github.com/ruanyf/weekly/issues/798#issuecomment-529282584)。简历投递haodong@hanhan.tech
