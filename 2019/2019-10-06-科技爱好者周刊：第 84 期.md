...
Disney + 视频订阅服务11月初发布后，影迷发现动画片《辛普森一家》变成了16:9宽屏。

第20季之前，《辛普森一家》的原始长宽比是4:3（下图一），迪斯尼公司这一次除了提升分辨率，还裁去了一些画面，统一将其转成了16:9（下图二）。迪斯尼已经同意，另行放出4：3版本，影迷可以自己选择看哪个版本。

《辛普森一家》一共30季，从第20季之后，原始播放的就是16:9版本。
...
这位 CEO 说：“这绝对是非常昂贵的，但也像一项投资。未来10年里，每个人都将'穿着'数字的时尚服装。这会是独特的纪念品和时代的标志。”根据他的预测，未来人们会有专门设计的数字媒体服装，让你在社交媒体上拥有独一无二的装饰，因为这种服装还可能有超现实的设计，现实中很难实现。这种服装还可以买卖和转让，因此有投资价值。
...
该项目使用软件操作大量镜子，把阳光反射到目标上，产生1500度的温度，是以前的商用太阳能系统的三倍。高温用来从水分子提取氢气，再把氢气用作燃料。高温也可以用来制造水泥，减少传统燃料的消耗。
...
> - [特斯拉](https://www.tesla.com/cybertruck)发布电动皮卡，最低售价4万美元。看着有点像装甲车，网上有人评论：“如果发生事故，会不会很难爬出来？”特斯拉的产品线越来越全了，已经有了轿车、卡车、皮卡，下一个会发布跑车。
...
上周，我推荐《在线》杂志的这篇长文。儿子得知父亲晚期肺癌以后，进行谈话录音，把内容做成一个对话机器人，父亲去世后还能跟他对话。当时我说，希望文章能有中文版。真有网友翻译了，而且译得很好，我再次读依然感动。我们太强调技术胜过人，但技术也可以有人性。
...
一款用 JavaScript 脚本绘制的英文字体，只要网页插入脚本，就能使用这个字体，特别适合制作字体动画。（@[rolitter](https://github.com/ruanyf/weekly/issues/923) 投稿）
...
QR 码本质是机器可读的字符串，主要缺点是人类无法辨识。现在有人提出了一种新的QR码，机器和人类都可读。就是如果字符很多，码图就会很大。
...
Azure 云服务的文档，有一部分专门讲解架构知识，包括架构模式，设计原则，设计模式等。（@[NeoTse](https://github.com/ruanyf/weekly/issues/928) 投稿）
...
GitHub 有一个官方仓库，收录政府的来函，要求取缔某些内容。现在里面有三个国家的政府来函：中国、俄国和西班牙。所以，放在 GitHub 上的东西，可以合法地被政府拿掉，所以不要乱放东西，尤其考虑到它的老板是微软。
