...
法国研究人员开发了一套装置，让一个脊髓受伤、四肢瘫痪的男人可以站起来走路。研究人员首先对病人进行了手术，将两个传感器放置在大脑表面，用来接受脑电波。

![](https://www.wangbase.com/blogimg/asset/201910/bg2019100406.jpg)

![](https://www.wangbase.com/blogimg/asset/201910/bg2019100407.jpg)

然后，计算机收到脑电波，将其转变为控制装甲的指令，让病人行走起来。整套装置重量达到65公斤，目前支持的动作有限，只是一个概念产品，只能在实验室内使用。
...
美国有一些 DNA 数据库网站，允许用户上传自己的 DNA，跟数据库已有的 DNA 进行匹配，找出你的远房亲戚。警察也使用这项功能，搜索犯罪现场发现的 DNA，由此抓到了不少犯人。上图就是通过公开的 DNA 数据库，找到的一个数十年前的连环杀手。

但是，这样就引发了隐私方面的担忧。即使你本人从未上传过自己的 DNA，只要你的亲戚上传了他的 DNA，照样可以发现你的生物特征。根据一项研究，现有规模的公开 DNA 数据库，已经可以覆盖60%的美国白人。美国司法部为此最近发布了规定，限制警察随意搜素 DNA 数据库，只有谋杀、强奸等暴力犯罪，以及识别人类遗体，才可以搜索公开的 DNA 数据库。
