...
这些机器人分别采用了吹奏、拨弦、打击三种截然不同的演奏技法。演奏的乐曲全部是原创音乐，为乐队量身打造的。设计师认为，机器人乐手有一些人类不具备的优点，比如吹奏竹笛时，机器人的气流可以随意调节，比人类的气息长得多。另外，人类只能用两只手打鼓，机器人有四只手臂，可以同时在四个不同音高的鼓上演奏。
...
2017年，美国政府的一份绝密报告泄漏出来，FBI 后来成功抓到了将这份报告打印、并携带出来的那个泄密者。这份报告的打印件被外界拿到以后，专家们发现了一个有趣的东西：打印件的页面上，出现了大量规则的黄点。它们用肉眼几乎看不见，但是在蓝光下可见（上图）。
...
> - [脸书公司](https://spectrum.ieee.org/tech-talk/robotics/artificial-intelligence/facebook-ai-launches-its-deepfake-detection-challenge)将发布一个工具，用来检测深度伪造的视频，比如检测出下图的人脸是合成的。
...
1、[手机钢琴](https://twitter.com/MKBHD/status/1214963208018001920)

下面这架钢琴的键盘是一加 7T 手机。

<iframe frameborder="0" src="https://v.qq.com/txp/iframe/player.html?vid=n3049xkzu4p" allowFullScreen="true"></iframe>
