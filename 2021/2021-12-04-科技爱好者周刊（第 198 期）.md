...
重庆两江新区新增两处文艺公交车站，其中一个车站采用了板凳造型。蓝色和红色两个硕大的板凳，为等车的乘客提供了休息空间，旁边紧紧围绕着17个小板凳，色彩缤纷，与不远的美术馆遥相呼应。（[via](https://www.cbg.cn/show/4933-1839848.html)）
...
1、[纸笔写代码的程序员](http://www.ctdsb.net/topic/1784/202203/03/164789.html)

![](https://cdn.beekka.com/blogimg/asset/202203/bg2022030505.webp)

3月3日，台湾发生大停电。一家软件公司为了不耽误工期，只得让程序员用纸笔撰写代码。

上午11时，只见公司6名程序员都在工位上，用手机打光，用纸笔撰写代码。问题是没有 IDE 和 API 手册，手写的话只能写伪码吧。
...
一家荷兰公司推出了两人座的观光潜水艇，最大特点就是速度非常快，可以达到每小时8节（14.8 公里/小时）。普通的观光潜水艇通常只有3节或4节。

这个速度虽然比不上大白鲨（56公里/小时）和剑鱼（130公里/小时），但可以跟上慢速前进的海豚。应该会有很多游客喜欢，与鱼群一起前进。
...
1、[家用 3D 打印不完全入坑指南](https://www.gcores.com/articles/147983)（中文）
...
1、[BaseMap](https://github.com/bojue/BaseMap)
...
1、[Orange](https://github.com/naaive/orange/blob/master/README_cn.md)
...
1、[程序员做饭指南](https://github.com/LeeJim/HowToCookOnMiniprogram)
...
1、[VCSLabel](https://github.com/pxzxj/VCSLabel)
...
1、[Remind](https://github.com/luvsic3/remind)
...
使用 React 实现开源 Windows 画板。（[@pengfeiw](https://github.com/ruanyf/weekly/issues/2250) 投稿）

1、[双精度浮点数的内部表示法](https://devtool.tech/double-type)

![](https://cdn.beekka.com/blogimg/asset/202203/bg2022030913.webp)

这个网页工具可以显示64位双精度浮点数的内部二进制表示法，可以输入一个数值，查看内部的浮点数构成。（[@shfshanyue](https://github.com/ruanyf/weekly/issues/2253) 投稿）
...
1、[AN-225](https://v.qq.com/x/page/u33265mp283.html)

![](https://cdn.beekka.com/blogimg/asset/202203/bg2022030704.webp)

世界最大飞机 AN-225，已经证实被摧毁了。估计以后也不会有人造那么大的飞机了，经济上不划算。
...
![](https://cdn.beekka.com/blogimg/asset/202203/bg2022030402.webp)

国外网友贴出了手机拍的 AN-225 降落视频，太漂亮了，像一只白色的大鸟。

<iframe frameborder="0" src="https://v.qq.com/txp/iframe/player.html?vid=u33265mp283" allowFullScreen="true" width="600" height="400"></iframe>
