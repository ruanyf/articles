...
亚马逊公司在弗吉尼亚州的第二总部，设计成了“玻璃螺旋塔”。该建筑高达107米，22层，外部有一圈露天的步道盘旋而上，种满了树木，可以从地面一直走到楼顶。该建筑预计明年动工。（[via](https://www.currentaffairs.org/2021/04/when-is-the-revolution-in-architecture-coming)）
...
1、[腾讯的退休福利](https://finance.sina.cn/7x24/2021-11-05/detail-iktzqtyu5527461.d.html)

![](https://cdn.beekka.com/blogimg/asset/202111/bg2021110503.jpg)

腾讯正式推出了员工退休待遇，应该是国内第一家规定退休待遇的大型互联网公司。具体方案是，员工在腾讯就职期间达法定年龄退休时，可享受三项福利：（1）定制纪念品；（2）长期服务感谢金，金额为6个月的固定工资；（3）退休荣誉金，由员工在“服务年限金”和“50%的未解禁股票期权”两项之中，自由选择其一。

根据这个方案，它的退休待遇就是一次性的一笔金钱，而不是每年都有的年金，跟退休工资不是一个概念，但总比没有好。当然，前提是你要能在腾讯待到法定退休年龄。我国目前的法定退休年龄是，男性年满60岁，女工人年满50岁，女干部年满55岁。

1、[进博会的金枪鱼王](https://www.sohu.com/a/499588872_161795)
...
为了保持新鲜，它每天每天需要换冰两次，每次换冰要消耗近1吨的碎冰。当天向观众展示以后，来自日本的专业技师当场进行了分割和加工，并将一部分鱼肉做成了刺身。
...
1、[iPhone 的微距镜头](https://lux.camera/iphone-macro-camera-a-big-day-for-small-things/)（英文）
...
1、[htpdate](https://github.com/bobwen-dev/htpdate/)

向服务器发出 HTTP 请求，服务器会返回请求时间。利用这个原理，这个工具向多个服务器发出请求，获取准确的当前时间，用来校准系统。它适用于无法使用 ntp 的场合。([@bobwen-dev](https://github.com/ruanyf/weekly/issues/2046) 投稿)
...
1、[《计算机体系结构基础》教科书](https://foxsen.github.io/archbase/)
...
1、[Paul Graham 文集](https://github.com/evmn/Paul-Graham)（Kindle 版）

![](https://cdn.beekka.com/blogimg/asset/202111/bg2021110603.jpg)

作者写了一个脚本，将 YC 创始人 Paul Graham 官网上面的文章都抓下来，生成了 mobi 电子书，可以在 Kindle 阅读。（[@evmn](https://github.com/ruanyf/weekly/issues/2041) 投稿）
