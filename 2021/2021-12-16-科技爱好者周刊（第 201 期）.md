...
你必须知道你在做什么，还必须估计出大概需要多长时间。如果你估计做蛋糕需要3个小时，超出一点时间，问题不大。但如果你实际上花了一周才做出蛋糕，蛋糕内部就会开始腐烂。

（2）蛋糕的体积很小，软件的体积也不应该很大。

小体积意味着你可以快速进行大量迭代，找出真正有效的方法。每次迭代都是一个实验，它帮你发现有价值的部分。小体积还可以很容易地进行试错。

（3）蛋糕有用户，软件也必须有用户。

如果你做出蛋糕，肯定会有人愿意尝尝。用户会提供真正客观的数据，帮助发现蛋糕怎样做比较好，以及哪些地方需要改进。这使得设计决策更容易。软件也必须有人愿意尝试，千万不要做出没有人愿意吃的蛋糕。

（4）做蛋糕很有趣，动手前你就知道会做出什么。

软件也应该这样，你能看到项目的终点。每做一次蛋糕，就测试一个新想法。如果这件事拖得太久，不再有趣，你很快就能感到。这时你应该停下来想一想，哪里做错了。
