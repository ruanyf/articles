...
1、[为什么 NFT 在技术上不可靠](https://threadreaderapp.com/thread/1445506673108406286.html)（英文）

NFT 是一种基于区块链的数字资产证明机制，目前非常热门。本文讨论了一些技术细节，认为它在技术上有缺陷，作为资产可能并不合适。
...
1、[Agora Flat](https://flat.whiteboard.agora.io/)
...
抖音前端团队推出的设计系统，支撑字节内部近千平台产品。目前提供50多个组件、国际化14种语言、使用TypeScript、SSR 等特性。（[@shijiatongxue](https://github.com/ruanyf/weekly/issues/2022) 投稿）

1、[smooth-signature](https://github.com/linjc/smooth-signature)
...
1、[微图](https://devtool.tech/tiny-image)
...
1、[awesome-console-services](https://github.com/chubin/awesome-console-services)

该仓库收集各种供命令行使用的外部服务，比如`curl ip-api.com`可以查看当前 IP 地址对应的地理位置。（[@ameizi](https://github.com/ruanyf/weekly/issues/2018) 投稿）

1、[awesome-metaverse](https://github.com/shadowcz007/awesome-metaverse)
