...
上周，首届中国国际消费品博览会在海口市开幕，开幕式上有1000架无人机表演了不同的形状，照亮了夜空。（[via](http://pic.people.com.cn/n1/2021/0507/c1016-32096680.html)）
...
本周的专题课就是讲解如何调用 Canvas 接口，构建一个你自己的简易绘图引擎，内容精炼实用，注重系统性，原理和实战并重。课程由腾讯课堂“双认证”机构——京程一灯制作，下面是主要课程内容。
