...
1、[发射火箭的新方法](https://www.odditycentral.com/news/innovative-company-uses-kinetic-energy-to-throw-rockets-into-space.html)
...
1、[Remix](https://blog.remix.run/p/remix-preview)
...
1、[树形目录列表生成器](https://devtool.tech/tree)

![](https://cdn.beekka.com/blogimg/asset/202111/bg2021112202.jpg)

一个网页小工具，生成文本的树形目录结构，方便插入文章。（[@shfshanyue](https://github.com/ruanyf/weekly/issues/2066) 投稿）
