...
11月24日，美国宇航局发射了一艘飞船，飞向一颗直径170米的小行星，计划将于明年9月下旬与后者相撞。这将是人类历史上第一次小行星碰撞实验。
...
上图中，白线是小行星的公转轨道，黄线是飞船的轨道，两者会相撞。美国宇航员希望通过这个实验，为人为改变小行星轨道积累经验，以防未来有小行星撞上地球。
...
1、[钉钉考勤作弊 APP 的法律争议](https://www.toutiao.com/a7028533764280500744/)（中文）

钉钉考勤作弊 APP 的作者，因为犯破坏计算机信息系统罪，一审判处有期徒刑五年六个月，二审改判四年。

但是，师认为其无罪，因为他的软件不触及钉钉程序本身，只是伪造了用户的地理位置，不属于“破坏”钉钉。本文是对律师的访问。

1、[中国 Flash 游戏的兴衰](https://chaoyang.substack.com/p/gold-miner-swf)（英文）

![](https://cdn.beekka.com/blogimg/asset/202111/bg2021112117.jpg)

一个英文播客的逐字稿，来宾讨论中国 Flash 游戏业是怎么兴起的，回忆了当年的一些情景。
...
1、[如何用 ssh-keygen 命令加密文件？](https://www.agwa.name/blog/post/ssh_signatures)（英文）

很少有人知道，ssh-keygen 命令除了生成密钥，还可以基于 SSH 密钥进行文件的加密/解密。

1、[我如何配置 VS Code 开发环境](https://pawelcislo.com/2021/11/14/my-vs-code-playground/)（英文）
...
1、[Plectica](https://www.plectica.com/)
...
一份英文的 PPT，详细浅显地解释了 Python 的迭代器（Generator）是怎么回事。（[@cheungfeifu](https://github.com/ruanyf/weekly/issues/2090) 投稿）
