...
上面代码中，`X`是`Y`的母亲（`mother(X, Y) `）为`true`，取决于两个条件。第一个条件是`Y`是`X`的小孩，第二个条件是`X`必须是女性。只有这两个条件都为`true`，才能得到`mother(X, Y)`为`true`。
...
（完）
<!--stackedit_data:
eyJoaXN0b3J5IjpbMzAzNDE3MDkyLC00ODU0NTMzMjAsMTY1ND
Y0NDA2MiwtNTczNjY3OTA5LC05MjE0Mjc5MzQsLTM5OTgwMDg5
NSwxNzA5OTA5MDAwLDUyNTQzNzI0MiwtODQ3NTExNjUsOTI0Nj
A1OTc4LC03ODY0ODkwMDIsLTE0NjAwMzc1ODEsLTEzMDQ5ODQ5
LDc3MTY3ODcyLC05NzQ2MTc4MDksLTYxNzk3MTU0MiwxNTQ5ND
M2NTIyLDIxMDQ0MTk3OTMsMTUyOTczMTk0OCwtNjM3MTEwXX0=
