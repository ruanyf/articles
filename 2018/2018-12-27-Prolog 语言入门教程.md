...
有几个地方需要注意。Prolog 所有语句的结尾都用一个“点”（`.`）表示结束。`write()`是打印命令。命令本身就是一个表达式，输出完成以后，返回值jiuis会返回`true.`，也会显示出来。
...
（完）
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTU3MDAxMDY5MSwxNjU0NjQ0MDYyLC01Nz
M2Njc5MDksLTkyMTQyNzkzNCwtMzk5ODAwODk1LDE3MDk5MDkw
MDAsNTI1NDM3MjQyLC04NDc1MTE2NSw5MjQ2MDU5NzgsLTc4Nj
Q4OTAwMiwtMTQ2MDAzNzU4MSwtMTMwNDk4NDksNzcxNjc4NzIs
LTk3NDYxNzgwOSwtNjE3OTcxNTQyLDE1NDk0MzY1MjIsMjEwND
QxOTc5MywxNTI5NzMxOTQ4LC02MzcxMTAsLTcwNDU1MTU3MF19
