...
Boddy 先生死于谋杀，现有六个嫌疑犯，每个人在不同的房间，每间房间各有一件可能的凶器。根据下面的线索，请你找出谁是凶手？

六个嫌疑犯是三男（George、John、Robert）三女（）。

```bash
man(george). man(john). man(robert).
```

There are three men () and three women (Barbara, Christine, Yolanda). Each person was in a different room (Bathroom, Dining Room, Kitchen, Living Room, Pantry, Study). A suspected weapon was found in each room (Bag, Firearm, Gas, Knife, Poison, Rope). Who was found in the kitchen?
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjAzMjg5NzcxMSw1MjU0MzcyNDIsLTg0Nz
