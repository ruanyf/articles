...
[Prolog](https://en.wikipedia.org/wiki/Prolog) 是一种与众不同的语言，不用来开发软件，专门解决逻辑问题。

![](https://www.doc.ic.ac.uk/project/examples/2012/163/g1216315/web/img/PrologLogo.jpg)

P
rolog 就是“逻辑编程”（programming of Logic）的意思。只要给定事实和规则，它会自动分析其中的逻辑关系，然后允许用户通过查询，完成复杂的逻辑运算。
...
学习之前，请安装 Prolog 的运行环境 [SWI-Prolog](http://www.swi-prolog.org/)，以便运行下面的代码。

![](https://i3.cpcache.com/product/787256299/SWI-Prolog_and_Owl_Mug_300x300.jpg?height=300&width=300&qv=90&side=back&color=White&Filters=[{%22name%22:%22background%22,%22value%22:%22ddddde%22,%22sequence%22:2}])
...
（完）
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTUwNjM1MTI0NCwtNTczNjY3OTA5LC05Mj
E0Mjc5MzQsLTM5OTgwMDg5NSwxNzA5OTA5MDAwLDUyNTQzNzI0
MiwtODQ3NTExNjUsOTI0NjA1OTc4LC03ODY0ODkwMDIsLTE0Nj
AwMzc1ODEsLTEzMDQ5ODQ5LDc3MTY3ODcyLC05NzQ2MTc4MDks
LTYxNzk3MTU0MiwxNTQ5NDM2NTIyLDIxMDQ0MTk3OTMsMTUyOT
czMTk0OCwtNjM3MTEwLC03MDQ1NTE1NzBdfQ==
-->