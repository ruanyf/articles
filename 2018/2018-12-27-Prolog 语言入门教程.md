...
上面代码中，`X`和`Y`都是大写，表示这是两个变量。符号`:-`表示推理关系，可以读成“取决于”，`X`是`Y`的朋友，取决于`Y`是`X`的朋友。
...
上面代码中，`X`是`Y`的母亲，取决于两个条件。第一个条件是`Y`

<!--stackedit_data:
eyJoaXN0b3J5IjpbMjA1MDY4MzA4LC05NzQ2MTc4MDksLTYxNz
k3MTU0MiwxNTQ5NDM2NTIyLDIxMDQ0MTk3OTMsMTUyOTczMTk0
OCwtNjM3MTEwLC03MDQ1NTE1NzBdfQ==
-->