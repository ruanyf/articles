...
如果括号里面只有一个参数，就表示某个对象拥有某个属性，比如 jack 是男性，要写成`male(jack).`。

### 
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTExODQxMjUwNywtNjE3OTcxNTQyLDE1ND
k0MzY1MjIsMjEwNDQxOTc5MywxNTI5NzMxOTQ4LC02MzcxMTAs
LTcwNDU1MTU3MF19
-->