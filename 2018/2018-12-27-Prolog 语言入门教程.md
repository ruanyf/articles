...
上面代码中，`colorify(A,B,C,D,E)`是一个对 ABCDE 五个变量求值的表达式。该表达式为`true`的条件是，这五个变量各自为一种颜色，则相伶

基本就是列举法。A 区域同时跟 BCDE 相邻，所以它们的颜色都不能一样。
...
（完）
<!--stackedit_data:
eyJoaXN0b3J5IjpbNDY5NTA4MTU1LC0xMDIwNTg5MTY0LC00OD
U0NTMzMjAsMTY1NDY0NDA2MiwtNTczNjY3OTA5LC05MjE0Mjc5
MzQsLTM5OTgwMDg5NSwxNzA5OTA5MDAwLDUyNTQzNzI0MiwtOD
Q3NTExNjUsOTI0NjA1OTc4LC03ODY0ODkwMDIsLTE0NjAwMzc1
ODEsLTEzMDQ5ODQ5LDc3MTY3ODcyLC05NzQ2MTc4MDksLTYxNz
k3MTU0MiwxNTQ5NDM2NTIyLDIxMDQ0MTk3OTMsMTUyOTczMTk0
OF19
-->