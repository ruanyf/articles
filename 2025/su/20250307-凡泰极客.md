...
上图是 Youtube 应用内置的“小游戏”，用的就是类似微信的小程序容器方案。

小程序这种设计有很多好处，可以方便地添加和更新功能，有利于形成外部生态和变现。

今天，就向大家介绍一个国产的小程序容器 [FinClip](https://www.finclip.com/landpage-product/?from=ruan)。如果你想为自己的 App 引入小程序，就用得到它。
...
可以看到，除了手机系统，它还可以支持嵌入桌面应用、车机应用、电视应用等等。
