...
公司要找一个程序员负责产出代码，但是代码是他让 AI 写的，不是他自己写的，那么应该怎么面试他呢？问哪些问题？

**显然，考察他的代码能力不重要，更重要的是考察他会不会 AI。** 只要善于使用 AI，能够产出合格的代码，对公司来说就是合格的人选。

但是，什么样的面试问题，能够考察出一个人是否掌握 AI。难道未来的面试问的都是下面这些问题：

- 你会写提示词吗，会使用 Skill 和 MCP 吗？
- 你的提示词是否清晰、有逻辑、切中要害？
- 如果模型报错、得不到结果，你会怎么处理？
- 怎么才能快速得到原型程序？如何让多个 Agent 并行工作？
- ……

真不敢想啊，以后的程序员面试，问的都是 AI 的使用问题，完全颠覆了。

我想了半天，如果我是面试官，怎么才能考察出应聘者是一个合格人选呢。除了确认对方掌握 AI，我可能还会问一些架构问题，应聘者可以不写代码，但是要懂架构。但也并非一定如此，有的公司已经接受了线上系统是一个黑箱，因为完全由 AI 生成的大型系统，必定迟早变成黑箱。

我还要看他以前的项目，如果以前他用 AI 做过类似的东西，那么大概率是合格人选。但这个方法也不可靠，很难遇到非常类似的大型项目，再说 AI 进化这么快，两年前的模型能力和与运行方式，现在早就面目全非了。

总之，我真的想不出来，什么是非常有效的面试问题。大家可以想想，你会怎么面试应聘者？

真的很难啊，**AI 时代考察各种编程细节意义不大**，因为不再需要记住细节，直接问大模型就行了。已经有公司明令不得人工写代码，那么才能识别出不写代码的优秀程序员呢？
...
1、[机柜种植](https://sa.lj.am/rack-mount-hydroponics/)

家里有多余的服务器机柜，怎么利用起来？

![](https://cdn.beekka.com/blogimg/asset/202603/bg2026031504.webp)

一个国外程序员就遇到这个问题，他想到机柜里面有电源，拉线和放置搁板都很方便，可以用来水培种植。
...
1、[my.WordPress.net](https://my.wordpress.net/)

![](https://cdn.beekka.com/blogimg/asset/202603/bg2026031502.webp)

如果你想尝试 WordPress，但没有服务器，可以使用官方新推出的这个服务，打开上面网址就可以了。

它把所有 PHP 脚本编译成 JS，在本地运行，不需要服务器，而且数据都在你的浏览器，下次打开这个网址，你的网站还在。

参考[介绍文章](https://wordpress.org/news/2026/03/announcing-my-wordpress/)。

1、[GrobPaint](https://github.com/groverburger/grobpaint)
...
1、[CheatReader](https://github.com/yaoyao2mm/cheatreader)
