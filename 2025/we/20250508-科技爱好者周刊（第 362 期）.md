...
1、[Learning](https://learning.google.com/experiments/learn-about/signup)

![](https://cdn.beekka.com/blogimg/asset/202508/bg2025081805.webp)

谷歌正在实验的新型学习平台，使用 AI 生成教程。

输入你想要学习的主题，比如 Java 语言。
...
警车一边开，一边扫描路上行人的面孔，跟警方的数据库比对。如果发现可疑人士，就会发出警报。
...
刚刚知道，GitHub 提供免费的 AI 模型调用，有 GPT-4o、DeepSeek-R1、Llama 3 等模型，不过有用量限制。

1、[用 JavaScript 生成迷宫](https://jrsinclair.com/articles/2025/joy-of-immutable-data-recursion-pure-functions-javascript-mazes/)（英文）

![](https://cdn.beekka.com/blogimg/asset/202508/bg2025082006.webp)

本文用通俗的语言，介绍一种生成迷宫的简单算法。

1、[Cloudflare 不是 CDN](https://magecdn.com/blog/2025/08/11/cloudflare-not-a-cdn/)（英文）
...
1、[Next QR Code Generator](https://github.com/chromium-style-qrcode/next-qrcode-generator)
...
1、[Translator 快速翻译](https://github.com/AnYi-0/Translator)
...
1、[Jupyter Notebook 转换网站](https://ipynbtopdf.net/)
...
1、[Coro Code](https://github.com/Blushyes/coro-code)
...
1、[Claude Code Status Bar Monitor](https://github.com/leeguooooo/claude-code-usage-bar)
...
1、[Citywalki](https://www.citywalki.com)
...
让我难以抗拒的是，与中国打交道比与其他任何地方打交道都容易得多。比如，我给中国某人发邮件，对方肯定会在24小时内回复，更有可能在4小时内。
...
AI 不会减少你掌握新技能所需要的付出，只会让你产生不必学习就已经学会的错觉。 
