...
2024年10月，三星公司董事长还因为半导体业绩不佳而[道歉](https://news.qq.com/rain/a/20241008A04KR000)，结果今年预测将成为[世界最赚钱公司](https://xueqiu.com/6600079272/374314156)。
...
1、[markstream-vue](https://github.com/Simon-He95/markstream-vue)

针对 ai 吐出的流式 markdown 的渲染库，提供 Vue 实现。（[@Simon-He95](https://github.com/ruanyf/weekly/issues/9999) 投稿）

1、[彩读｜ColorTxt](https://github.com/ssnangua/ColorTxt)
...
移除 AI 图片水印的命令行工具，本身也是一个 Python 软件包，可以移除可见水印和不可见水印（比如谷歌的 SynthID）。
...
1、[Lucarne](https://github.com/tuchg/Lucarne)
