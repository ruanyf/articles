...
这表明牛会使用工具，以前从未有人提过的。目前，除了人类之外，只有黑猩猩被发现会使用工具。

![](https://cdn.beekka.com/blogimg/asset/202601/bg2026012407.webp)

科学家表示，这件事表明需要重新认识牛的智力。
...
1、[选择性禁用 HTTP/1.0 和 HTTP/1.1](https://markmcb.com/web/selectively_disabling_http_1/)（英文）

![](https://cdn.beekka.com/blogimg/asset/202601/bg2026012301.webp)

本文介绍如何设置 nginx，为 HTTP/1.0 和 HTTP/1.1 开设白名单，这可以杜绝绝大部分的攻击和爬虫。
