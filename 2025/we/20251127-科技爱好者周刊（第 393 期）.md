...
1、[Gridea Pro](https://github.com/Gridea-Pro/gridea-pro)
...
1、[Recordly](https://github.com/webadderall/Recordly)

![](https://cdn.beekka.com/blogimg/asset/202604/bg2026041202.webp)

开源的录屏与编辑工具，适用于演示、产品展示、教程、讲解视频等，可以录制整个屏幕或单个窗口，并直接进入编辑器。（[@Hao4Wang](https://github.com/ruanyf/weekly/issues/9571) 投稿）

1、[水印](https://wt.65536.dev/)
...
1、[Input 0](https://github.com/10xChengTu/input0)

免费开源的 macOS 语音输入工具，本地运行，支持大模型对识别的文本进行润色。（[@Justin3go](https://github.com/ruanyf/weekly/issues/9607) 投稿）

## AI 相关

1、[EVA](https://github.com/usepr/eva)

一个极简的 AI 编程智能体，只是单个的 Python 脚本，定位为低配版 Claude Code，可以参考它的实现。（[@usepr](https://github.com/ruanyf/weekly/issues/9560) 投稿）

1、[claude-msync](https://github.com/debugtheworldbot/msync)

一个命令行工具，导出 claude code 的记忆（memory），可以输入 Claude 客户端或其他 AI Agent。（[@debugtheworldbot](https://github.com/ruanyf/weekly/issues/9589) 投稿）
...
1、[2026世界新闻摄影大赛获奖作品](https://petapixel.com/2026/04/09/over-70-powerful-winners-from-the-2026-world-press-photo-contest/?user_id=66c4c9305d78644b3ac5df9c)
