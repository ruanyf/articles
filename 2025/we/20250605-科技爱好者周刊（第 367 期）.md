...
谷歌说，它是目前“**最先进的图像生成和编辑模型**”。

我试用后，感觉确实很强，而且好处是免费使用，打开[官网](https://aistudio.google.com/prompts/new_chat?model=gemini-2.5-flash-image-preview)（下图）就可以用。

![](https://cdn.beekka.com/blogimg/asset/202509/bg2025092111.webp)

如果访问不了官网，周刊讨论区也有接入官方 API 的[第三方网站](https://github.com/search?q=repo%3Aruanyf%2Fweekly+nano+banana&type=issues)，不过大部分要收费。

对于这个模型，网上充满了各种神奇的用法，网友甚至收集成了一个仓库“[Awesome Nano Banana images](https://github.com/PicoTrex/Awesome-Nano-Banana-images)”。

![](https://cdn.beekka.com/blogimg/asset/202509/bg2025092113.webp)

我从这个仓库里面，挑了几个很实用的例子，分享给大家。我想，其他模型应该也能做到吧。

### （1）人像处理

人像处理是最常用的场景，我们先上传一张生活照片。
...
可以看到，效果很震撼。这意味着，人物的表情、发型、化妆、服饰、姿势都是可以改变的。

下面，我们单独试一下，改变人物的表情，让其侧脸对着镜头微笑。
...
你可以改变物品的包装，“将图二的漫画形象，贴到图一的包装盒，生成一张专业的产品照”。
...
上传一张地图，上面标有你选择的地点，让模型“生成沿着红色箭头看到的场景。”
