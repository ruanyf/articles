...
1、[IT 行业的就业岗位](https://www.derekthompson.org/p/the-25-most-interesting-ideas-ive)

根据玛丽·米克尔的 AI 报告，如果从 IT 行业中剔除 AI 相关岗位，美国 IT 行业的就业人数多年来一直处于持平或下降趋势。
...
这是一个 JS 库，会将第三方代码加载到一个单独域名 googleusercontent.com 上面，再用 iframe 插入当前网页，这样就提供了最大限度的隔离。

1、[离线应用为什么尚未流行？](https://marcobambini.substack.com/p/why-local-first-apps-havent-become)（英文）
...
1、[如何使用 Python 生成音频的文字稿](https://www.pavlinbg.com/posts/python-speech-to-text-guide)（英文）

![](https://cdn.beekka.com/blogimg/asset/202509/bg2025092302.webp)

一篇简单的入门教程，一步步教你自己写 Python 脚本，通过 Whisper 模型提取音频的文字稿。

1、[避免使用 @ts-ignore](https://evanhahn.com/ts-ignore-is-almost-always-the-worst-option/)（英文）
...
1、[如何调整 systemd 加快启动](https://www.xda-developers.com/systemd-tweaks-boost-boot-time/)（英文）
...
1、[Atlas](https://github.com/karam-ajaj/atlas)
...
1、[Hamsterbase Tasks](https://github.com/hamsterbase/tasks)
...
1、[db-back-tool](https://github.com/iKeepLearn/db-back-tool)

网友自己写的 PostgreSQL/MySQL 数据库的备份工具，可以自动备份、加密、压缩，并将备份文件上传至腾讯云 COS 或阿里云 OSS。（[@iKeepLearn](https://github.com/ruanyf/weekly/issues/7798) 投稿）
...
它来自 NotebookLM 的主创人员，他们离开谷歌后开发的产品。目前免费使用，参见[介绍文章](https://www.xda-developers.com/huxe-app-official-launch/)。
...
1、[binglish](https://github.com/klemperer/binglish)
...
1、[Neovate](https://github.com/neovateai/neovate-code)
...
1、[FlyCut Caption](https://github.com/x007xyz/flycut-caption)
...
1、[NPM 安全最佳实践](https://github.com/bodadotsh/npm-security-best-practices)

最近爆出了一系列 npm 软件包投毒事件，这个仓库收录了各种可以采用的安全措施，分为使用者和发布者两大部分。
...
1、[人体的毛织模型](https://www.knitted-anatomy.at/respiratory-system/)

一位英国的医学博士，业余时间喜欢织毛线。有一天，她突然想到，可以毛线编织出人体器官的模型。
