...
1、[Python 脚本运行器 uv 教程](https://docs.astral.sh/uv/guides/scripts/)（英文）
...
1、[Ethersync](https://github.com/ethersync/ethersync)
...
开源的新闻热点助手，通过 GitHub Pages 抓取国内11个主流平台上，指定主题的热点新闻。（[@sansan0](https://github.com/ruanyf/weekly/issues/7375) 投稿）

1、[MUSIX](https://github.com/coolcode/musix)
...
1、[ImageKit](https://github.com/hzbd/imagekit)

批量图片处理的命令行工具，使用 Rust 语言编写。（[@hzbd](https://github.com/ruanyf/weekly/issues/7387) 投稿）

1、[刷新率体验](https://github.com/MaskerPRC/refresh-rate-expericence)
...
1、[weekly-git-summary](https://github.com/yinzhenyu-su/weekly-git-summary)
...
1、[简历警察](https://github.com/itMrBoy/resumePolice)

Dify 的插件，AI 修改简历，修改点参考它的[提示词](https://github.com/itMrBoy/resumePolice/blob/main/prompt/resume_police_Zh.md)。（[@Disdjj](https://github.com/itMrBoy/resumePolice) 投稿）

1、[Belin Doc](https://belindoc.com/zh)

![](https://cdn.beekka.com/blogimg/asset/202507/bg2025073003.webp)

免费的文档 AI 翻译站点，保留格式，支持 PDF/PPTX/EPUB/DOCX 等多种文件（[@K8S666](https://github.com/ruanyf/weekly/issues/7384) 投稿）
...
1、[LaTeX 训练营](https://pipeak.share4y.cn/)
...
我很担忧，生成式 AI 的广泛应用，使得人们不再完整地阅读任何内容。

以前，我们为了让人们了解长篇报告，会做成幻灯片。即便如此，还要反复向听众强调其中的重点内容。

想要人们阅读长篇内容，几乎是不可能的。人们一看到大段文字就会跳过去，只会看一眼图片。

现在，AI 来了，人们更不会阅读完整内容了。他们只会让 AI 去读，然后看一眼生成的内容总结。
